...
- bunny
---
**edit:** This was an **April's fools joke**. However, **bunny will remain functional**. It's only implemented as a thing wrapper around benchee so unless we completely break API (which I don't see coming) it'll remain functional. Continue reading for cute bunny pictures. It is time for [benchee](https://github.com/PragTob/benchee) to take the next step in its evolution as one of the prime benchmarking libraries. Going forward benchee will be called [bunny](https://github.com/PragTob/bunny)! [caption id="attachment_media-17" align="alignnone" width="972"]![IMG_20171207_084810_Bokeh-ANIMATION.gif](https://pragtob.wordpress.com/wp-content/uploads/2018/04/img_20171207_084810_bokeh-animation.gif) Al likes the naming change![/caption] We waited for this **very special day** to announce this very special naming change - what better day to announce something is being named bunny than _Easter Sunday_? It is available [on hex.pm now](https://hex.pm/packages/bunny)!
